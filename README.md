...
YelpCamp is a full stack application that allows users to add, rate, and review campgrounds. It was developed as part of Colt Steele's Web Development Bootcamp.
